                ...
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {contactInfo.map((item, index) => (
                                <div 
                                    key={index}
                                    className="bg-white p-5 rounded-xl border border-gray-100 hover:shadow-lg transition-shadow duration-300"
                                >
                                    <div className="w-10 h-10 bg-[#1a365d]/5 rounded-lg flex items-center justify-center mb-3">
                                        <item.icon className="w-5 h-5 text-[#1a365d]" />
                                    </div>
                                    <p className="text-xs text-gray-500 uppercase tracking-wider">{item.label}</p>
                                    <p className="font-semibold text-[#1a365d] mt-1">{item.value}</p>
                        ...
                        <div className="mt-8 p-6 bg-green-50 rounded-2xl border border-green-100">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-semibold text-gray-900">Prefer WhatsApp?</p>
                                    <p className="text-sm text-gray-600">Message us directly for quick responses</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 border border-gray-100">
                            <h3 className="text-xl font-semibold text-[#1a365d] mb-6">Request Free Consultation</h3>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div>
                                    ...
                                    <Input
                                        ...
                                        className="h-12 rounded-xl border-gray-200 focus:border-[#d4a574] focus:ring-[#d4a574]"
                                    />
                                </div>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Tell us about your dental needs</label>
                                    <Textarea
                                        placeholder="I'm interested in dental implants..."
                                        value={formData.message}
                                        onChange={(e) => setFormData({...formData, message: e.target.value})}
                                        className="min-h-[120px] rounded-xl border-gray-200 focus:border-[#d4a574] focus:ring-[#d4a574] resize-none"
                                    />
                                </div>
