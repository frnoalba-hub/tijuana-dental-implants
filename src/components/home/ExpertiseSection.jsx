            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-[#1a365d] mt-3 mb-6">
                        Instructor & Leader
                        <span className="block text-gray-600 font-normal text-2xl mt-2">in Advanced Implant Surgery</span>
                    </h2>
                ...
                <motion.div
                    ...
                    className="mt-16 bg-gradient-to-br from-[#1a365d]/5 to-[#d4a574]/5 border border-[#1a365d]/10 rounded-3xl p-8 md:p-12 text-center"
                >
