...
const officeImages = [
    {
        ...
        caption: "Reception and private treatment suites"
    },
    {
        src: "/office/bz-office-7.png",
        alt: "Blaze Dental interior and branding wall",
        caption: "Signature interior and lighting"
    },
    {
        src: "/office/bz-office-2.png",
        alt: "Private operatory at Blaze Dental",
        caption: "Private operatories with natural light"
    },
    {
        src: "/office/bz-office-4.png",
        alt: "Treatment chair at Blaze Dental",
        caption: "Comfort-focused treatment rooms"
    },
    {
        src: "/office/bz-office-3.png",
        alt: "Blaze Dental front desk",
        caption: "Welcoming check-in area"
    },
    {
        src: "/office/bz-office-5.png",
        alt: "Reception and treatment bay",
        caption: "Built for an easy patient flow"
    },
    {
        src: "/office/bz-office-6.png",
        alt: "Modern operatory setup",
        caption: "Fully equipped treatment stations"
    },
    {
        src: "/office/bz-office-1.png",
        alt: "Treatment room through arched entry",
        caption: "Calm spaces with premium finishes"
    }
];
...
const galleryTabs = {
    office: {
        label: "New Office",
        description: "A look inside Blaze Dental's upgraded clinic environment.",
        images: officeImages,
        initialVisible: 8,
        loadStep: 4
    },
    courses: {
        ...
        description: "Surgical training, certifications, and international education.",
        images: courseImages,
        initialVisible: 9,
        loadStep: 9
    }
...
export default function GallerySection() {
    ...
    const [visibleCounts, setVisibleCounts] = useState({
        office: galleryTabs.office.initialVisible,
        courses: galleryTabs.courses.initialVisible
    });

    const currentTab = galleryTabs[activeTab];
    const visibleImages = currentTab.images.slice(0, visibleCounts[activeTab]);
    const hasMore = visibleCounts[activeTab] < currentTab.images.length;
        ...
        <section id="gallery" className="py-16 sm:py-24 bg-blaze-depth">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-8 sm:mb-12">
                    {Object.entries(galleryTabs).map(([key, tab]) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 sm:px-6 py-2 sm:py-2.5 rounded-md text-sm font-medium transition-colors duration-200 ${
                                    isActive
                                        ? "bg-white text-black"
                            ...
                            >
                                {tab.label}
                                <span className="ml-2 text-xs opacity-70">({tab.images.length})</span>
                            </button>
                        );
                    })}
                </div>
                        ...
                        <Button
                            ...
                            onClick={() =>
                                setVisibleCounts((prev) => ({
                                    ...prev,
                                    [activeTab]: Math.min(
                                        prev[activeTab] + currentTab.loadStep,
